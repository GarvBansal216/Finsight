...
const supportingFeatures = [
  ...
  {
    icon: <LineChart size={22} className="text-white" />,
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="relative py-12 md:py-20 overflow-hidden bg-transparent">
        <DicedHeroSection
          topText="Discover"
          mainText="Financial Intelligence"
          subMainText="Transform your financial documents into actionable insights with AI-powered analysis. Get instant access to smart dashboards, automated reports, and intelligent recommendations that help you make better financial decisions."
          buttonText="Get Started"
          slides={[
            {
              title: "AI-Powered Analytics",
              image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=800&fit=crop&auto=format",
            },
            {
              title: "Investment Tracking",
              image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=800&fit=crop&auto=format",
            },
            {
              title: "Financial Reports",
              image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=800&fit=crop&auto=format",
            },
            {
          ...
          {coreFeatures.map((feature, index) => (
            ...
            >
              <div className="md:w-1/2 space-y-6">
                <div className="w-16 h-16 rounded-[14px] bg-gradient-to-br from-[#1E40AF] to-[#8B5CF6] flex items-center justify-center mb-6 shadow-[0_4px_12px_rgba(30,64,175,0.4)]">
                  {feature.icon}
                </div>

                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-[1.2] tracking-[-0.01em]">
                  {feature.title}
                </h2>

                <p className="text-lg md:text-xl text-gray-300 mb-8 leading-[1.6] font-medium">
                  {feature.description}
                </p>
              ...
              <div className="md:w-1/2 flex justify-center">
                <div className="bg-gray-900/50 border-2 border-gray-800 rounded-[20px] w-full max-w-md overflow-hidden shadow-[0_8px_24px_rgba(0,0,0,0.5)] hover:shadow-[0_12px_32px_rgba(0,0,0,0.7)] transition-all duration-300">
                  {feature.id === "ai-insights" ? (
                    ...
                    <div className="h-80 flex items-center justify-center text-gray-400">
                      <div className="text-center">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-xl bg-gray-800/80 backdrop-blur-sm flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
                          <ShieldCheck className="w-8 h-8 text-[#1E40AF]" />
                        </div>
                        <p className="font-semibold text-white">Security Dashboard Preview</p>
                      </div>
                    </div>
                  )}
                </div>
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 lg:mb-20">
            ...
            <p className="text-base md:text-lg text-gray-300 max-w-2xl mx-auto leading-[1.6] font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {supportingFeatures.map((f, index) => (
              <div
                key={index}
                className="group bg-gray-900/50 backdrop-blur-sm p-6 lg:p-8 rounded-[20px] border-2 border-gray-800 hover:border-[#1E40AF]/50 shadow-[0_1px_3px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_24px_rgba(30,64,175,0.3)] transition-all duration-300 hover:-translate-y-1"
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1E40AF] to-[#8B5CF6] flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-[0_2px_8px_rgba(30,64,175,0.4)]">
                    {f.icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-white mb-2 text-lg leading-[1.3]">{f.title}</h3>
                    <p className="text-sm text-gray-400 leading-[1.6]">{f.description}</p>
                  </div>
                </div>
              </div>
            ))}
